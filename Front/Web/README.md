...
viewport : 현재 화면에 보여지는 영역을 의미한다.
위 설정을 통해 다양한 device에서도 동일하게 화면에 표시할 수 있다
...
CSS 함수 : 주어진 인수를 전달하면 결과값을 속성에 적용하는 방식이 있다.
ex) calc() -> 계산식의 결과를 속성값으로 지정

미디어 쿼리 : 미디어 타입을 인식, 콘텐츠를 읽어들이는 기기의 물리적 속성을 감지한다. -> 미덩 타입과 쿼리로 구성되어져 있다.
ex) screen의 width를 쿼리로 사용을 자주한다.
...
1.
/Users/taeyang/Desktop/스크린샷 2022-05-08 오후 5.32.54.png


2. 
/Users/taeyang/Desktop/스크린샷 2022-05-08 오후 5.33.04.png
